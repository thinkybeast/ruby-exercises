...
# change :database_handle to reader, as we may not want to overwrite our db 
# could also remove the reader altogether, as there may be no cases where we want to provide direct access to our databse.