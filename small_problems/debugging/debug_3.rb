...
=begin
On line 9, we incorrectly use assignment in our condition, rather than comparison. Because the result of the assignment will always be truthy, the conditional will always evaluate to true and return true
=end